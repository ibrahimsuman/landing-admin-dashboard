      ...
      <div className="flex flex-col gap-4 w-full lg:w-1/3">
        ...
        <Card className="w-full h-32 lg:h-full flex-1">
          <CardContent className="flex justify-between items-center h-full px-3">
            <div>
              <p className="text-xs uppercase tracking-wide text-gray-500">Incoming</p>
              <p className="text-lg font-bold">{incoming}</p>
            </div>
        ...
        <Card className="w-full h-32 lg:h-full flex-1">
          <CardContent className="flex justify-between items-center h-full px-3">
            <div>
              <p className="text-xs uppercase tracking-wide text-gray-500">Ongoing</p>
